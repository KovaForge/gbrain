    ...
    if (existsSync(lockDir)) {
      ...
      try {
        ...
        if (!isProcessAlive(lockPid)) {
          ...
          // Lock is held by a live process. Do not steal it just because
          // the operation is long-running; embed/import can legitimately
          // hold the DB for much longer than a few minutes.
